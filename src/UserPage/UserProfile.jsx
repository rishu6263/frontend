                ...
                <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                    <div className="col-span-4 sm:col-span-3">
                        <div className="bg-white shadow rounded-lg p-6">
                            <div className="flex flex-col items-center">
                                <img src={patientimage} alt="John Doe" className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0" />
                    ...
                    <div className="col-span-4 sm:col-span-9">
                        <div className="bg-white shadow rounded-lg p-6">
                            ...
                            <h3 className="font-semibold text-center mt-3 -mb-2">About Patient</h3>
                            <div className="flex justify-center items-center gap-6 my-6"></div>
                            <h2 className="text-xl font-bold mt-6 mb-4">Allergies</h2>
                            <div className="mb-6">
                                <div className="flex justify-between flex-wrap gap-2 w-full">
                                    <span className="text-gray-700 font-bold">Surgeries</span>
                                    <p>
